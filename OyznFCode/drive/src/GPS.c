...
uint16_t GPS_Sate_Num=0,Last_GPS_Sate_Num=0;//参与定位卫星数
...
uint8_t GPS_FixType=0;//定位类型
uint8_t GPS_Fix_Flag[4]={0};//定位标志
float Horizontal_Acc_Est=0;//水平位置精度
int16_t Vertical_Acc_Est=0;//竖直位置精度
int16_t Speed_Acc_Est=0;//竖直位置精度
