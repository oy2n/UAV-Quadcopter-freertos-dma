...
__attribute__((aligned(32))) u8 mem2base[MEM2_MAX_SIZE] __attribute__((at(0XC01F4000)));	//外部SDRAM内存池,前面2M给LTDC用了(1280*800*2)
__attribute__((aligned(32))) u8 mem3base[MEM3_MAX_SIZE] __attribute__((at(0X10000000)));	//内部CCM内存池
